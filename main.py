...
from telewebion import telewebion
from tva import tva
from bbcpersian import bbcpersian
...
VIDEOS = {'Other': [bbcpersian(),
                    {'name': 'RADIO JAVAN',
                     'thumb': 'https://www.radiojavan.com/images/nav_logo.png',
                     'video': 'https://stream.rjtv.tv/live/smil:rjtv.smil/playlist.m3u8',
                     'genre': 'MUSIC'},
                    {'name': 'RADIO FARDA',
                     'thumb': 'https://www.radiofarda.com/Content/responsive/RFE/fa-IR/img/logo.png',
                     'video': 'https://rfeaudio-lh.akamaihd.net/i/PACKRFE_Axia21@828907/index_64_a-p.m3u8?sd=10&rebase=on',
                     'genre': 'RADIO'},
                    {'name': 'MANOTO',
                     'thumb': 'https://www.manototv.com/Content/Images/manoto-logo-1c5dc5.png',
                     'video': 'https://d2rwmwucnr0d10.cloudfront.net/live.m3u8',
                     'genre': 'ENTERTAINMENT'},
                    {'name': 'IRAN INTERNATIONAL',
                     'thumb': 'https://iranintl.com/sites/all/themes/irani/logo.svg',
                     'video': 'https://live.playstop.me/LS-63503-4/index.m3u8',
                     'genre': 'NEWS'}],
...
def list_videos(category):
    ...
    for video in videos:
        try:
            ...
            logger.exception('LIST VIDEOS FAILED')
